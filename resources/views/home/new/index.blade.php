...
{{--                        <a href="{{url('/new/{{$pid}}/{{$id}}')}}" class="imgbox clearfix tr1">--}}
                        <a href="{{route('home.new.cont',[1,1])}}" class="imgbox clearfix tr1">
                    ...
                    <div class="hezi">
                        <a href="news-show.php?id=34&type_id=13" class="imgbox clearfix tr1">
                            <div class="tu pull-left">
                                <div class="img tr1 item22" data-original="/uploads/uploadpic/20200721194649mqye.jpg" style="background-position:center; background-size:cover;"></div>
                            </div>
                            <div class="text clearfix">
                                <div class="tou overflow tr1" title="">别墅地下室空间防水防潮的重点与解决方案</div>
                                <div class="zi">
                                    &nbsp;相关问题，一直是防水行业的技术难点，因地下空间结构复杂、旧防水材料生产所执行的规范较早，结合我公司30多年的防水施工经验，针对不同客户的不同需求，结合我公司的施工革新理念“以防潮防霉为主、以堵漏为辅、防潮防霉一体化”制定出专项防湿维修方案，再利用我公司的环保产品，真正实现维修一次可使用20年以上的一劳永逸解....
                                </div>
                                <div class="xia clearfix">
                                    <div class="time pull-left">2020-07-21</div>
                                    <div class="more pull-right tr1">查看详情</div>
