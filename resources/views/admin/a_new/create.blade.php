...
@section('content')
    ...
    <article class="page-container">
        <form action="{{ route('admin.new.store') }}" method="post" class="form form-horizontal" id="form-admin-role-add">
            @csrf
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-10">
                    <input type="text" class="input-text" value="" name="new_name">
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-10">
                    <input type="text" class="input-text" value="" name="view_count">
                </div>
            </div>
            <div class="row cl">
                <label class="form-label col-sm-2">是否热门：</label>
                <input type="checkbox" name="is_hot" value="T">

            </div>
            <div class="row c1">
                <label class="form-label col-sm-2">是否推荐：</label>
                <input type="checkbox" name="is_recommend" value="T">
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-10">
                    <textarea name="new_cont" id="editor" cols="30" rows="10"></textarea>
                </div>
            </div>
            <div class="row cl">
