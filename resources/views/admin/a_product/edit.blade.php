...
{{--    {{ $id }}--}}
    <article class="page-container">
        <form action="{{ route('admin.product.update',$id) }}" method="post" class="form form-horizontal" id="form-admin-role-add">
            @csrf
            ...
            <div class="row cl">
                ...
                <div class="formControls col-sm-10">
                    <input type="text" class="input-text" value="{{ $data->pro_name }}" name="pro_name">
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <div class="uploader-thum-container">
                        ...
                        <div class="col-xs-8">
                            <img src='{{ $data->pro_pic }}' style="width: 100px;" id="pic">
                        </div>
                    </div>
                </div>
            </div>
